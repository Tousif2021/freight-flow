    ...
    duration: 0.3
      ...
      <AnimatePresence>
        ...
        height: 0
            ...
            <div className="grid grid-cols-2 gap-2">
              {/* Traffic API */}
              <div className={cn("p-2 rounded-lg border transition-all", trafficStatus === 'done' ? "bg-teal/10 border-teal/30" : "bg-muted/10 border-border/30")}>
                ...
                ease: "linear"
                    ...
                    </motion.div> : <Route className="w-3 h-3 text-teal" />}
                ...
                <div className="h-1 bg-muted/30 rounded-full overflow-hidden">
                  <motion.div className={cn("h-full rounded-full", trafficStatus === 'done' ? "bg-teal" : "bg-primary")} style={{
              ...
              {/* Weather API */}
              <div className={cn("p-2 rounded-lg border transition-all", weatherStatus === 'done' ? "bg-teal/10 border-teal/30" : "bg-muted/10 border-border/30")}>
                <div className="flex items-center gap-1.5 mb-1">
                ...
                ease: "linear"
                      ...
                      <Loader2 className="w-3 h-3 text-primary" />
                    </motion.div> : <Satellite className="w-3 h-3 text-teal" />}
                ...
                <div className="h-1 bg-muted/30 rounded-full overflow-hidden">
                  <motion.div className={cn("h-full rounded-full", weatherStatus === 'done' ? "bg-teal" : "bg-primary")} style={{
      ...
      <div className="glass-card overflow-hidden relative">
        ...
        <div className="relative p-4">
          <div className="flex items-center justify-between mb-1">
            ...
            <motion.span className={cn('px-2.5 py-1 rounded-full text-[9px] font-bold uppercase tracking-wide flex items-center gap-1.5 border', eta.riskLevel === 'low' && 'bg-teal/20 text-teal border-teal/40', eta.riskLevel === 'medium' && 'bg-amber/20 text-amber border-amber/40', eta.riskLevel === 'high' && 'bg-red-600/30 text-red-300 border-red-500/40')} animate={eta.riskLevel === 'high' ? {
      ...
      <div className="glass-card overflow-hidden">
        ...
        <div className="p-2 space-y-1.5">
          ...
          {carrierFactor && <motion.div initial={{
          opacity: 0,
          x: -10
        }} animate={{
          opacity: 1,
          x: 0
        }} variants={cardHoverVariants} whileHover="hover" transition={{
          delay: 0.05
              ...
              <div className="relative flex items-center gap-2">
                <motion.div className="w-8 h-8 rounded-lg flex items-center justify-center bg-red-500/20" variants={iconHoverVariants} animate={{
              ...
              repeat: Infinity
                ...
                <motion.div className="flex items-center gap-1 px-2 py-1 rounded bg-red-500/20 group-hover:bg-red-500/30 transition-colors" whileHover={{
              scale: 1.05
            }}>
          ...
          {trafficFactor && <motion.div initial={{
          opacity: 0,
          x: -10
        }} animate={{
          opacity: 1,
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-0.5 mt-2">
                    <div className="flex-1 h-0.5 bg-muted/30 rounded-full relative">
                      <motion.div className="absolute right-1/4 -top-1.5 w-1.5 h-1.5 bg-red-400 rounded-full" animate={{
                    scale: [1, 1.3, 1]
                  }} transition={{
                    duration: 1.5,
                    repeat: Infinity
          ...
          delay: 0.15
              ...
              <div className="relative flex items-center gap-2">
                ...
                <motion.div className="flex items-center gap-1 px-2 py-1 rounded bg-teal/20 group-hover:bg-teal/30 transition-colors" whileHover={{
              scale: 1.05
            }}>
          ...
          {weatherFactor && <motion.div initial={{
          opacity: 0,
          x: -10
        }} animate={{
          opacity: 1,
          ...
          delay: 0.2
            ...
            backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noise'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.65' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noise)'/%3E%3C/svg%3E")`
              ...
              <div className="relative flex items-center gap-2">
                ...
                <motion.div className="flex items-center gap-1 px-2 py-1 rounded bg-amber/20 group-hover:bg-amber/30 transition-colors" whileHover={{
              scale: 1.05
            }}>
        ...
        <div className="px-3 py-2 bg-muted/10 border-t border-border/30 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            {['Overview', 'Alternatives', 'History'].map((label, i) => <motion.div key={label} className={cn("w-2 h-2 rounded-full cursor-pointer transition-all", i === 0 ? "bg-primary scale-110" : "bg-teal/50 hover:bg-teal/70")} initial={{
            scale: 0
          }} animate={{
            scale: 1
          }} whileHover={{
